...
const links = [
  ...
  {
    id: 5,
    href: '/content/inKindDonation',
    label: 'إدارة التبرعات العينية',
    isAccordion: false,
    icon: (
      <svg
        xmlns='http://www.w3.org/2000/svg'
      ...
      >
        <path
          d='M12 22.0001V13.0001M15.17 2.21005C15.4191 2.0708 15.6997 1.99768 15.985 1.99768C16.2704 1.99768 16.551 2.0708 16.8 2.21005L21 4.57005C21.2975 4.73826 21.5449 4.98242 21.7171 5.27758C21.8893 5.57275 21.98 5.90834 21.98 6.25005C21.98 6.59177 21.8893 6.92736 21.7171 7.22253C21.5449 7.51769 21.2975 7.76185 21 7.93005L8.82002 14.7901C8.57006 14.9321 8.2875 15.0067 8.00002 15.0067C7.71254 15.0067 7.42998 14.9321 7.18002 14.7901L3.00002 12.4301C2.70257 12.2619 2.45511 12.0177 2.28293 11.7225C2.11075 11.4274 2.02002 11.0918 2.02002 10.7501C2.02002 10.4083 2.11075 10.0727 2.28293 9.77758C2.45511 9.48242 2.70257 9.23826 3.00002 9.07005L15.17 2.21005Z'
          stroke='currentColor'
          strokeWidth='2'
          strokeLinecap='round'
...

  {
    ...
    children: [
      ...
      {
        id: 52,
        href: '/content/donars?type=individuals',
        isSearchParams: true,
        label: 'الأفراد',
      },
      {
        id: 53,
        href: '/content/donars?type=organizations',
        isSearchParams: true,
        label: 'المنظمات',
      },
      {
        id: 54,
        href: '/content/donars?type=business',
        isSearchParams: true,
        label: 'رجال الأعمال',
      },
    ],
        ...
        <ul>
          {links.map((link) => {
            const isActiveAccordion =
              link.isAccordion && link.baseHref
                ? location.pathname.includes(link.baseHref)
                : link.children?.some((child) => {
                    return location.pathname.includes(child.href);
                  });
            ...
            return (
              <li key={link.id}>
                <Accordion
                  disableGutters
                  elevation={0}
                  defaultExpanded={isActiveAccordion}
                  className={`sidebar-accordion ${
                    isActiveAccordion ? 'active-accordion' : ''
                  }`}
                    ...
                    {link.children.map((child) => (
                      <Typography key={child.id} variant='body2'>
                        <NavLink
                          to={child.href}
                          className={() => {
                            if (child.isSearchParams) {
                              return currentUrl === child.href ? 'active' : '';
                            }
