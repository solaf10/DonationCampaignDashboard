...
/* const columns = [
  ...
  { id: 'last-donation', label: 'أخر تبرع' },
  { id: 'date', label: 'تاريخ الاستحقاق' },
  { id: 'donation-type', label: 'طريقة التبرع' },
...
const BusinessDonars = () => {
  ...
  return (
    <PageContainer>
      <Title pageTitle='إدارة المتبرعين' subtitle='رجال أعمال' />

      {/* Table & filter */}

      <div className='table-content business-donars'>
        {/* filter holder */}
        ...
        <PageTable columns={columns} rows={rows} pageLink='/content/business' />
      </div>
    </PageContainer>
  );
};
